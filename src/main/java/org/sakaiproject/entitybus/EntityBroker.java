/**
 * $Id: EntityBroker.java 67 2009-04-14 07:10:48Z azeckoski $
 * $URL: http://entitybus.googlecode.com/svn/tags/entitybus-1.0.8/api/src/main/java/org/sakaiproject/entitybus/EntityBroker.java $
...
import org.sakaiproject.entitybus.entityprovider.extension.PropertiesProvider;
import org.sakaiproject.entitybus.entityprovider.extension.TagProvider;
...
/**
 * This service interface defines the exposed entity functions available from the
 * providers registered with the system<br/> 
 * It allows developers, etc. to access entity information
 * 
...
public interface EntityBroker extends PropertiesProvider, TagProvider {
    ...
    /**
     * Fire an event to the underlying event system with the specified name, targeted at the supplied reference, which
     * should be a reference to an existing entity managed by this broker<br/>
     * <b>NOTE:</b> This will allow events to be fired for references without a provider or which are invalid references
     * 
     ...
     * else from the underlying entity system<br/>
