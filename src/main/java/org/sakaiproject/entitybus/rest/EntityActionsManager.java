/**
 * $Id: EntityActionsManager.java 105 2010-07-23 13:10:39Z azeckoski $
 * $URL: http://entitybus.googlecode.com/svn/tags/entitybus-1.0.8/rest/src/main/java/org/sakaiproject/entitybus/rest/EntityActionsManager.java $
        ...
        if (ActionsExecutionControllable.class.isAssignableFrom(actionProvider.getClass())) {
            ...
            if (method == null) {
                try {
                    ...
                    throw new RuntimeException("Fatal error trying to get custom action method ("+customAction+"): "+e1, e1);
            ...
            try {
                ...
                throw new RuntimeException("IllegalArgument: Fatal error trying to execute custom action method ("+customAction+"): "+e, e);
            } catch (IllegalAccessException e) {
                throw new RuntimeException("IllegalAccess: Fatal error trying to execute custom action method ("+customAction+"): "+e, e);
                ...
                if (e.getCause() != null) {
                    if (e.getCause().getClass().isAssignableFrom(IllegalArgumentException.class)) {
                        ...
                        throw (FormatUnsupportedException) e.getCause();
                ...
                throw new RuntimeException("ITE: Fatal error trying to execute custom action method ("+customAction+"): "+e.getCause(), e);
            }
        }
        if (result != null) {
