/**
 * $Id: EntityProviderManager.java 17 2009-02-17 12:33:06Z azeckoski $
 * $URL: http://entitybus.googlecode.com/svn/tags/entitybus-1.0.8/api/src/main/java/org/sakaiproject/entitybus/entityprovider/EntityProviderManager.java $
...
public interface EntityProviderManager {
     ...
     * programatically (do not forget to unregister if you code is shutting down),
     * this replaces an existing entity provider which
