/**
 * $Id: EntityBrokerManagerImpl.java 17 2009-02-17 12:33:06Z azeckoski $
 * $URL: http://entitybus.googlecode.com/svn/tags/entitybus-1.0.8/impl/src/main/java/org/sakaiproject/entitybus/impl/EntityBrokerManagerImpl.java $
...
import org.sakaiproject.entitybus.access.AccessViews;
import org.sakaiproject.entitybus.access.EntityViewAccessProvider;
...
import org.sakaiproject.entitybus.entityprovider.capabilities.BrowseNestable;
import org.sakaiproject.entitybus.entityprovider.capabilities.BrowseSearchable;
import org.sakaiproject.entitybus.entityprovider.capabilities.Browseable;
import org.sakaiproject.entitybus.entityprovider.capabilities.BrowseableCollection;
...
import org.sakaiproject.entitybus.entityprovider.capabilities.EntityViewUrlCustomizable;
import org.sakaiproject.entitybus.entityprovider.capabilities.ReferenceParseable;
...
import org.sakaiproject.entitybus.entityprovider.extension.BrowseEntity;
...
import org.sakaiproject.entitybus.util.request.RequestUtils;
...
public class EntityBrokerManagerImpl implements EntityBrokerManager {
    public static String SVN_REVISION = "$Revision: 17 $";
    public static String SVN_LAST_UPDATE = "$Date: 2009-02-17 20:33:06 +0800 (周二, 17 二月 2009) $";
    ...
    /* (non-Javadoc)
     * @see org.sakaiproject.entitybus.EntityBrokerManager#setServletContext(java.lang.String)
     */
     ...
     * {@link org.sakaiproject.entitybus.util.servlet.DirectServlet} must be deployed there on this
     * server.
     * 
    ...
    /* (non-Javadoc)
     * @see org.sakaiproject.entitybus.EntityBrokerManager#getEntityRESTProvider()
     */
    ...
    /* (non-Javadoc)
     * @see org.sakaiproject.entitybus.impl.EntityBrokerManager#getExternalIntegrationProvider()
     */
    ...
    /* (non-Javadoc)
     * @see org.sakaiproject.entitybus.EntityBrokerManager#getEntityProviderManager()
     */
    ...
    /* (non-Javadoc)
     * @see org.sakaiproject.entitybus.EntityBrokerManager#getEntityPropertiesService()
     */
    ...
    /* (non-Javadoc)
     * @see org.sakaiproject.entitybus.EntityBrokerManager#getEntityViewAccessProviderManager()
     */
    ...
    /* (non-Javadoc)
     * @see org.sakaiproject.entitybus.EntityBrokerManager#getEntityProviderMethodStore()
     */
    ...
    /* (non-Javadoc)
     * @see org.sakaiproject.entitybus.EntityBrokerManager#getRequestGetter()
     */
    ...
    /* (non-Javadoc)
     * @see org.sakaiproject.entitybus.EntityBrokerManager#getRequestStorage()
     */
    ...
    /* (non-Javadoc)
     * @see org.sakaiproject.entitybus.EntityBrokerManager#setEntityRESTProvider(org.sakaiproject.entitybus.providers.EntityRESTProvider)
     */
    ...
    /* (non-Javadoc)
     * @see org.sakaiproject.entitybus.EntityBrokerManager#setExternalIntegrationProvider(org.sakaiproject.entitybus.providers.ExternalIntegrationProvider)
     */
