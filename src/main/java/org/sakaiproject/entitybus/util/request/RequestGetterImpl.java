/**
 * $Id: RequestGetterImpl.java 17 2009-02-17 12:33:06Z azeckoski $
 * $URL: http://entitybus.googlecode.com/svn/tags/entitybus-1.0.8/utils/src/main/java/org/sakaiproject/entitybus/util/request/RequestGetterImpl.java $
...
public class RequestGetterImpl implements RequestGetter, RequestGetterWrite {
    ...
    /* (non-Javadoc)
     * @see org.sakaiproject.entitybus.entityprovider.extension.RequestGetter#getRequest()
     */
    ...
    /* (non-Javadoc)
     * @see org.sakaiproject.entitybus.entityprovider.extension.RequestGetter#getResponse()
     */
    ...
    /* (non-Javadoc)
     * @see org.sakaiproject.entitybus.entityprovider.extension.RequestGetterWrite#setRequest(javax.servlet.http.HttpServletRequest)
     */
    ...
    /* (non-Javadoc)
     * @see org.sakaiproject.entitybus.entityprovider.extension.RequestGetterWrite#setResponse(javax.servlet.http.HttpServletResponse)
     */
