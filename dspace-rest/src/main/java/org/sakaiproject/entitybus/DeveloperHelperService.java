/**
 * $Id: DeveloperHelperService.java 17 2009-02-17 12:33:06Z azeckoski $
 * $URL: http://entitybus.googlecode.com/svn/tags/entitybus-1.0.8/api/src/main/java/org/sakaiproject/entitybus/DeveloperHelperService.java $
 ...
 * entity providers and working with entity references and entity objects
 * 
...
public interface DeveloperHelperService {
    ...
    /**
     * <b>Convenience method from {@link EntityBroker}</b><br/>
     * Fire an event with the specified name, targetted at the supplied reference, which
     ...
     * else from the underlying entity system
     * 
     * @param reference a globally unique reference to an entity, 
     * consists of the entity prefix and optional segments
    ...
    /**
     * @return the entity reference (/group/{groupId}) of the current location for the current session
     * (represents the current group/location of the current user in the system)
     */
    ...
    /**
     * @param locationReference the location reference (/group/{groupId})
     ...
     * (in most systems this is going to be the default start location for users, a gateway or home portal)
     */
    public String getStartingLocationReference();

    /**
     * Get the entity reference of the location of a user's home/personal group/space
     * @param userReference the user entity reference (e.g. /user/{userId} - not id, eid, or username)
     * @return the entity reference of the location OR null if it cannot be found or generated
     */
     ...
     * it will work for any entity type which uses permissions
     * 
     * @param userReference the user entity reference (e.g. /user/{userId} - not id, eid, or username)
     * @param permission a permission string constant
     ...
     * work for any entity type which uses permissions
     * 
     * @param reference a globally unique reference to an entity, 
     * consists of the entity prefix and optional segments (normally the id at least)
     * @param permission a permission string constant
    ...
    /**
     * @return the full server base URL + any extra portal location info (e.g. http://server:port/portal)
     */
    public String getPortalURL();   

    /**
     * @param locationReference an entity reference to a location (e.g. /group/{groupId})
     * @return the full URL to a location (e.g. http://server:port/portal/group/azhome)
    ...
    /**
     * @param userReference the user entity reference (e.g. /user/{userId} - not id, eid, or username)
     * @return the full URL to a user's workspace/homespace (e.g. http://server:port/portal/home/~someuser)
