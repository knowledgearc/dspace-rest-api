/**
 * $Id: EntityHandlerImpl.java 73 2009-04-14 09:03:49Z azeckoski $
 * $URL: http://entitybus.googlecode.com/svn/tags/entitybus-1.0.8/rest/src/main/java/org/sakaiproject/entitybus/rest/EntityHandlerImpl.java $
...
import org.sakaiproject.entitybus.access.AccessFormats;
...
import org.sakaiproject.entitybus.access.HttpServletAccessProvider;
...
import org.sakaiproject.entitybus.entityprovider.capabilities.RequestHandler;
...
import org.sakaiproject.entitybus.util.http.HttpResponse;
import org.sakaiproject.entitybus.util.http.LazyResponseOutputStream;
import org.sakaiproject.entitybus.util.http.HttpRESTUtils.Method;
import org.sakaiproject.entitybus.util.request.RequestUtils;
import org.sakaiproject.entitybus.utils.ClassLoaderReporter;
...
public class EntityHandlerImpl implements EntityRequestHandler {
    ...
    public static String SVN_REVISION = "$Revision: 73 $";
    public static String SVN_LAST_UPDATE = "$Date: 2009-04-14 17:03:49 +0800 (周二, 14 四月 2009) $";
    ...
    /* (non-Javadoc)
     * @see org.sakaiproject.entitybus.EntityRequestHandler#handleEntityAccess(javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse)
     */
    ...
    /* (non-Javadoc)
     * @see org.sakaiproject.entitybus.EntityRequestHandler#handleEntityError(javax.servlet.http.HttpServletRequest, java.lang.Throwable)
     */
